declare module "@quadrant/quadrant-node" {
	...
	export interface QuadrantClient {
		...
		on(eventName: "event", listener: (payload: QuadrantEventEnvelope) => void): () => void;
		on(eventName: string, listener: (payload: unknown) => void): () => void;
		off(eventName: "event", listener: (payload: QuadrantEventEnvelope) => void): void;
		off(eventName: string, listener: (payload: unknown) => void): void;
		once(eventName: "event", listener: (payload: QuadrantEventEnvelope) => void): void;
